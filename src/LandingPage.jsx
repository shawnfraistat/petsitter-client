    ...
    <div className="landing-div">
      ...
      <div className="first-question-div">
        ...
        <div className="text-div">
          ...
          <p className="landing-page-text">So he created this site, which allows pet sitters to post their information and exchange messages with clients, and clients to search for sitters who match their specifications.</p>
          <p className="landing-page-text">If you want to use this site as a sitter, it&apos;s as simple as signing up and waiting for the messages to roll in. As for clients, they can sign up and search away!</p>
        </div>
      </div>
      ...
      <div className="third-question-div">
        ...
        <div className="row verified-div">
          <div className="verified-text-div">
            ...
            <br />
            <br />
            &#42; No. This isn&apos;t real. If any of our sitters actually respond to your messages, run.
          </div>
